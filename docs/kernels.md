...
323 ops. TensorFlow registers 108 more for a GPU device on its own, before this plugin loads, and those are not listed here: the table is the difference the plugin makes.
...
| `FakeQuantWithMinMaxArgs` | (no dtype constraint) |  | [metal_quant_ops.mm:924](../src/tensorflow/core/common_runtime/metal/kernels/metal_quant_ops.mm#L924) |
| `FakeQuantWithMinMaxArgsGradient` | (no dtype constraint) |  | [metal_quant_ops.mm:926](../src/tensorflow/core/common_runtime/metal/kernels/metal_quant_ops.mm#L926) |
| `FakeQuantWithMinMaxVars` | (no dtype constraint) |  | [metal_quant_ops.mm:928](../src/tensorflow/core/common_runtime/metal/kernels/metal_quant_ops.mm#L928) |
| `FakeQuantWithMinMaxVarsGradient` | (no dtype constraint) |  | [metal_quant_ops.mm:930](../src/tensorflow/core/common_runtime/metal/kernels/metal_quant_ops.mm#L930) |
| `FakeQuantWithMinMaxVarsPerChannel` | (no dtype constraint) |  | [metal_quant_ops.mm:932](../src/tensorflow/core/common_runtime/metal/kernels/metal_quant_ops.mm#L932) |
| `FakeQuantWithMinMaxVarsPerChannelGradient` | (no dtype constraint) |  | [metal_quant_ops.mm:934](../src/tensorflow/core/common_runtime/metal/kernels/metal_quant_ops.mm#L934) |
...
| `Lu` | float32 |  | [metal_linalg_ops.mm:636](../src/tensorflow/core/common_runtime/metal/kernels/metal_linalg_ops.mm#L636) |
...
| `Qr` | float32 |  | [metal_linalg_ops.mm:625](../src/tensorflow/core/common_runtime/metal/kernels/metal_linalg_ops.mm#L625) |
| `QuantizeAndDequantizeV2` | float32 | input_max, input_min | [metal_quantize_dequantize_ops.mm:691](../src/tensorflow/core/common_runtime/metal/kernels/metal_quantize_dequantize_ops.mm#L691) |
| `QuantizeAndDequantizeV3` | float32 | input_max, input_min, num_bits | [metal_quantize_dequantize_ops.mm:693](../src/tensorflow/core/common_runtime/metal/kernels/metal_quantize_dequantize_ops.mm#L693) |
| `QuantizeAndDequantizeV4` | float32 | input_max, input_min | [metal_quantize_dequantize_ops.mm:696](../src/tensorflow/core/common_runtime/metal/kernels/metal_quantize_dequantize_ops.mm#L696) |
| `QuantizeAndDequantizeV4Grad` | float32 | input_max, input_min | [metal_quantize_dequantize_ops.mm:698](../src/tensorflow/core/common_runtime/metal/kernels/metal_quantize_dequantize_ops.mm#L698) |
...
| `SelfAdjointEigV2` | float32 |  | [metal_linalg_ops.mm:626](../src/tensorflow/core/common_runtime/metal/kernels/metal_linalg_ops.mm#L626) |
...
| `SparseReshape` | (no dtype constraint) |  | [metal_sparse_manip_ops.mm:814](../src/tensorflow/core/common_runtime/metal/kernels/metal_sparse_manip_ops.mm#L814) |
